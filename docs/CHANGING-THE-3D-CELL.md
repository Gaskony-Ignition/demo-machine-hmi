...
The default stations sit 1.98 m from the robot base: close enough that the
far column of a 1.2 m pallet stays inside a 2.5 m arm's reach, which the solve
